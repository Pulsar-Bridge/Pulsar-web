...
// Proxies GET /stats/daily?days=N (pulsar-core src/handlers/stats.rs daily_totals).
export async function GET(request: NextRequest) {
  try {
    const result = await relayAdminGet("/stats/daily", request.nextUrl.searchParams);
